      ...
      <div v-else>
        ...
        <section class="flex flex-col mt-5 mx-5 md:mx-20 lg:flex-row lg:justify-between lg:mx-32">
          ...
          <div class="w-full md:w-[90%] lg:w-[25%] flex flex-col items-center mb-5 z-10 mx-auto">
            ...
            <router-link to="/mpa/anime/streaming" class="p-2 px-10 bg-trueGray-600 hover:bg-blue-700 duration-200 rounded-lg text-center font-semibold w-[90%] uppercase">Streaming</router-link>
