...
<script>
import Header from '@/components/zakat/calculate/ZakatHeader.vue'
import Footer from '@/components/zakat/calculate/ZakatFooter.vue'
import Switcher from '@/components/zakat/calculate/Switcher.vue'

import ZakatFitrah from '@/components/zakat/calculate/Fitrah.vue'
import ZakatMal from '@/components/zakat/calculate/Mal.vue'
import Infaq from '@/components/zakat/calculate/Infaq.vue'
